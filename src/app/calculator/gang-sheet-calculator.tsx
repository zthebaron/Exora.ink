...
export function GangSheetCalculator() {
  const {
    rollMode,
    switchRollMode,
    assumptions,
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-left">
                    ...
                    <th className="pb-3 pr-4 text-right font-medium text-muted-foreground">Retail</th>
                    <th className="pb-3 pr-4 text-right font-medium text-muted-foreground">Wholesale</th>
                    <th className="pb-3 pr-4 text-right font-medium text-muted-foreground">Cost</th>
                    <th className="pb-3 pr-4 text-right font-medium text-muted-foreground">Gross Profit</th>
